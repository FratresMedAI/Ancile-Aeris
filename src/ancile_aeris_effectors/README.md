# ancile_aeris_effectors

Simulation-safe non-kinetic effector catalog and selection policy for the
Ancile Aeris counter-UAS stack. This package models a layered defeat
...
```bash
ros2 launch ancile_aeris_effectors ancile_aeris_effectors.launch.py
```

This is included automatically by
`ancile_aeris_basic_demo.launch.py` when
