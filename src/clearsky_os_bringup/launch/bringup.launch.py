...
FEATURE_DEFAULTS = {
    ...
    "enable_clearsky_os_scout_mothership": "true",
    "enable_clearsky_os_baby_interceptor": "false",
}
...
def generate_launch_description() -> LaunchDescription:
    ...
    enable_clearsky_os_scout_mothership = LaunchConfiguration("enable_clearsky_os_scout_mothership")
    enable_clearsky_os_baby_interceptor = LaunchConfiguration("enable_clearsky_os_baby_interceptor")
    ...
    actions = [
        ...
        _feature_arg("enable_clearsky_os_scout_mothership", feature_defaults),
        ...
        _include("clearsky_os_swarm_intent", "clearsky_os_swarm_intent.launch.py"),
        ...
        _include("clearsky_os_scout_mothership", "clearsky_os_scout_mothership.launch.py", IfCondition(enable_clearsky_os_scout_mothership)),
        _include("clearsky_os_baby_interceptor", "clearsky_os_baby_interceptor.launch.py", IfCondition(enable_clearsky_os_baby_interceptor)),
    ]
