...
def generate_launch_description() -> LaunchDescription:
    ...
    fob_swarm = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([FindPackageShare("scout_mothership"), "/launch/fob_swarm.launch.py"]),
        launch_arguments={
    ...
    micro_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            [FindPackageShare("ancile_aeris_micro_payloads"), "/launch/micro_payloads.launch.py"]
        ),
