"""Tests for clearsky_os_scout_mothership (imports monolithic node module from source tree)."""

from importlib.util import module_from_spec, spec_from_file_location
from pathlib import Path

_NODE = Path(__file__).resolve().parent.parent / "clearsky_os_scout_mothership" / "scout_node.py"
