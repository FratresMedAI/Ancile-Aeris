...
def generate_launch_description() -> LaunchDescription:
    return LaunchDescription([
        ...
        Node(package="ancile_aeris_sensors", executable="ancile_aeris_thermal_node", name="ancile_aeris_thermal_node", output="screen"),
        ...
        Node(package="ancile_aeris_sensors", executable="ancile_aeris_demo_context_node", name="ancile_aeris_demo_context_node", output="screen"),
    ])
