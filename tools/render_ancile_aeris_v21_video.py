...
OUTPUT = OUT_DIR / "Ancile_Aeris_v2.1_LRBAA_BORAP_04_4min_demo.mp4"
...
def bg(title: str, kicker: str = "Ancile Aeris v2.1 | LRBAA BORAP 04 | Simulation Only") -> Image.Image:
...
SUBTITLES = [
    (0, 15, "Ancile Aeris v2.1: ROS 2 counter-UAS software for LRBAA 24-01 and BORAP 04, demonstrated in simulation only."),
    ...
    (48, 68, "The authoritative demo remains Docker-only: clean build, source the workspace, and launch ancile_aeris_basic_demo."),
    ...
    (210, 240, "Ancile Aeris v2.1 remains simulation-honest, human-governed, auditable, and ready for LRBAA reviewer inspection."),
]
