...
reported to the maintainers at `conduct@fratres-x.ai`.
...
1. **Correction** — private written warning and clarity on expectations
2. **Warning** — warning with consequences for continued behavior
3. **Temporary ban** — temporary ban from interaction
