...
|---|---|---|---|
| 0:00-0:15 | Opening slate | Ancile Aeris v2.1 title, LRBAA BORAP 04, simulation-only badge | Solicitation responsiveness and simulation boundary. |
...
python tools\render_ancile_aeris_v21_video.py
```

Outputs:

- Key frames: `artifacts/video_v21/keyframes/*.png`
- MP4: `artifacts/video_v21/Ancile_Aeris_v2.1_LRBAA_BORAP_04_4min_demo.mp4`
...
- **Final video with narration:** `artifacts/video_v21/Ancile_Aeris_v2.1_LRBAA_BORAP_04_4min_demo_with_voiceover.mp4`

Spoken transcript (manual recording option): [`submission/Ancile_Aeris_Voiceover_Narration_v2.1.md`](Ancile_Aeris_Voiceover_Narration_v2.1.md)
