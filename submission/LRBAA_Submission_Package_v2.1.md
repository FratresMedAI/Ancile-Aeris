Revised May 8, 2026 — ClearSky OS **v2.1** (LRBAA **24-01** · BORAP **04**)

# LRBAA submission package index (v2.1)

**Property of Fratres X AI** · https://github.com/Fratres-X-AI/ClearSky-OS
...
|-------------|---------------------------|------------------------------|
| Concept Paper | [`ClearSky_OS_Concept_Paper_v2.1.md`](ClearSky_OS_Concept_Paper_v2.1.md) | [`ClearSky_OS_Concept_Paper_v2.1.docx`](ClearSky_OS_Concept_Paper_v2.1.docx) |
| Quad Chart (layout + copy) | [`ClearSky_OS_Quad_Chart_v2.1.md`](ClearSky_OS_Quad_Chart_v2.1.md) | [`ClearSky_OS_Quad_Chart_v2.1.docx`](ClearSky_OS_Quad_Chart_v2.1.docx) |
...
| On-screen / caption script | [`ClearSky_OS_Video_Script_v2.1.md`](ClearSky_OS_Video_Script_v2.1.md) · [`.docx`](ClearSky_OS_Video_Script_v2.1.docx) |
| Full voiceover narration (timed) | [`ClearSky_OS_Voiceover_Narration_v2.1.md`](ClearSky_OS_Voiceover_Narration_v2.1.md) · [`.docx`](ClearSky_OS_Voiceover_Narration_v2.1.docx) |
| **Primary reviewer video with recorded narration** | `artifacts/video_v21/ClearSky_OS_v2.1_LRBAA_BORAP_04_recorded_voiceover_demo.mp4` |
...
| Silent render (burned-in subtitles) | Repository: `artifacts/video_v21/ClearSky_OS_v2.1_LRBAA_BORAP_04_4min_demo.mp4` |
| With AI voiceover (Edge TTS mux) | `artifacts/video_v21/ClearSky_OS_v2.1_LRBAA_BORAP_04_4min_demo_with_voiceover.mp4` |
| Key frames (CapCut / editor) | `artifacts/video_v21/keyframes/*.png` |
| Local render CLI | `python tools/render_clearsky_os_v21_video.py` |
